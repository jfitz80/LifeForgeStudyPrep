...
export default async function KnowledgeArticlePage({ params }: Props) {
  ...
  const sourcePath = `/knowledge/${clusterData.slug}/${articleData.slug}`;
    ...
    <main className="min-h-screen bg-[#F5F7FA] py-12">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <header className="mb-8 rounded-2xl border border-slate-200 bg-white p-7 shadow-sm">
          ...
          <Link
            href={`/knowledge/${clusterData.slug}`}
            ...
            actions={[
              {
                ...
                eventPayload: {
                  ...
                  cta_type: 'article_studying',
                  content_type: 'knowledge_article',
                  topic: articleData.slug
                }
              },
              {
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_280px]">
          <article className="rounded-2xl border border-slate-200 bg-white p-7 shadow-sm">
            <section>
              ...
              <InlineGlossaryText
                text={articleData.explanation}
                className="mt-3 text-sm leading-7 text-[#4A5568]"
              />
            </section>
            ...
            <section className="mt-8 rounded-xl border border-[#F9D4D4] bg-[#FFF6F6] p-5">
              ...
              <InlineGlossaryText
                text={articleData.commonMistakes}
                className="mt-3 text-sm leading-7 text-[#6B2B2B]"
              />
            </section>
            ...
            <section className="mt-8 rounded-xl border border-[#D8ECE8] bg-[#F2FBF8] p-5">
              ...
              <InlineGlossaryText
                ...
                className="mt-3 text-sm leading-7 text-[#2D5D58]"
              />
            </section>
          </article>
        ...
        <div className="mt-8">
          <ContextualCTA
            ...
            body="If this article made the concept clearer, the next useful step is to test whether you can use it in a question. Start with free practice or go deeper with full exam prep."
            variant="gap"
            actions={[
              {
                label: 'Start Free Practice',
                ...
                eventPayload: {
                  source_page: sourcePath,
                  destination_page: '/free-practice',
                  cta_type: 'article_bottom_studying',
                  content_type: 'knowledge_article',
                  topic: articleData.slug
                }
              },
