      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-4 py-16 sm:px-6 md:py-20 lg:grid-cols-2 lg:gap-14 lg:px-8 lg:py-24">
        <div className="flex flex-col justify-center">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link
              href="/knowledge"
              className="inline-flex items-center rounded-lg bg-[#2FAF9E] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#279989] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2FAF9E] focus-visible:ring-offset-2"
            >
            ...
            <Link
              href="/news"
              className="inline-flex items-center rounded-lg border border-slate-300 bg-white px-5 py-3 text-sm font-semibold text-[#1F2A44] transition hover:border-[#2FAF9E] hover:text-[#2FAF9E] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2FAF9E] focus-visible:ring-offset-2"
            >
              View Latest News
            </Link>
          </div>
        ...
        <div className="flex items-center">
          <div className="relative w-full rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
