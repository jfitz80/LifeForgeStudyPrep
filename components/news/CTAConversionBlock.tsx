...
export default function CTAConversionBlock({ compact = false }: CTAConversionBlockProps) {
  return (
    <div className={`rounded-xl border border-[#CFEAE4] bg-[#F1FBF8] ${compact ? 'p-4' : 'p-5'}`}>
      <h4 className="text-sm font-bold text-[#1F2A44]">Preparing for the LLQP?</h4>
      <p className="mt-1 text-sm text-[#3F4D62]">Test your knowledge with real exam-style questions.</p>
